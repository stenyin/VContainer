...
func _enter_tree():
	...
	add_autoload_singleton("VContainerFrameProviderDispatcher", "res://addons/VContainer/Runtime/Godot/FrameProviderDispatcher.cs")
...
func _exit_tree():
	...
	remove_autoload_singleton("VContainerFrameProviderDispatcher")
