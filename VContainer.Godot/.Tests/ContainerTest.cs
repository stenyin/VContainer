...
public class ContainerTest
{
    ...
    public void ResolveCollection()
    {
        ...
        IObjectResolver? container = builder.Build();
        var enumerable = container.Resolve<IEnumerable<I1>>().ToArray();
        I1 e0 = enumerable.ElementAt(0);
        I1 e1 = enumerable.ElementAt(1);
    ...
    public void ResolveOpenGeneric()
    {
        ...
        Assert.That(obj2, Is.SameAs(obj3));
        Assert.That(obj3, Is.SameAs(obj4));
        Assert.That(obj1, Is.Not.SameAs(obj5));
    ...
    public void RegisterFromFunc()
    {
        ...
        builder.Register(c => { return new ServiceA(c.Resolve<I2>()); }, Lifetime.Scoped);
    ...
    public void RegisterFromFuncWithInterface()
    {
        ...
        builder.Register<I4>(c => { return new ServiceA(c.Resolve<I2>()); }, Lifetime.Scoped);
    ...
    {
        var builder = new ContainerBuilder();
        builder.Register(_ => { return new DisposableServiceA(); }, Lifetime.Scoped);
    ...
    public void CircularDependency()
    {
        ...
        IInjector? injector = InjectorCache.GetOrBuild(typeof(HasCircularDependency1));
    ...
    public void CircularDependencyMsg()
    {
        ...
        IInjector? injector = InjectorCache.GetOrBuild(typeof(HasCircularDependencyMsg1));

        // Only reflection mode can detect circular dependency errors at runtime.
        if (injector is ReflectionInjector)
        {
            var ex = Assert.Throws<VContainerException>(() => builder.Build());
            const string expected = "Circular dependency detected!\n" +
    ...
    public void TryResolveTransient()
    {
        ...
        Assert.That(container.TryResolve<NoDependencyServiceA>(out NoDependencyServiceA? obj1), Is.True);
        Assert.That(container.TryResolve<NoDependencyServiceA>(out NoDependencyServiceA? obj2), Is.True);
        Assert.That(container.TryResolve<NoDependencyServiceB>(out NoDependencyServiceB? obj3), Is.False);
    ...
    public void TryResolveScoped()
    {
        ...
        IObjectResolver? container = builder.Build();
        Assert.That(container.TryResolve<DisposableServiceA>(out DisposableServiceA? obj1), Is.True);
        Assert.That(container.TryResolve<DisposableServiceA>(out DisposableServiceA? obj2), Is.True);
        Assert.That(container.TryResolve<DisposableServiceB>(out DisposableServiceB? obj3), Is.False);
